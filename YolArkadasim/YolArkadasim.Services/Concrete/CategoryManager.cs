...
namespace YolArkadasim.Services.Concrete
{
    ...
    {
        private readonly IUnitOfWork _unitOfWork; //unitofwork ekliyoruz
        private readonly IMapper _mapper; //mapper ekliyoruz
        ...
        {
            var category = await _unitOfWork.Categories.GetAsync(c => c.Id == categoryId); //categoryId'yi category'e include etmiş oluyoruz. (Eşitliyoruz)
            if (category != null)
            {
                //category null değilse
